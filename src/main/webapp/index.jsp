...
<head>
    ...
    <title>登录</title>
    <!-- 处理默认样式 -->
    <link rel="stylesheet" href="./WEB-INF/pages/css/reset.css" />
    <!-- 登录css样式 -->
    <link rel="stylesheet" href="./WEB-INF/pages/css/index/login.css" />
    <!-- 引入网页标题图标 -->
    <link rel="shortcut icon" href="./WEB-INF/pages/OES_favicon%20.ico" type="image/x-icon">
</head>
<body>
<form action="${pageContext.request.contextPath}/LoginService/login" method="post" id="loginForm">
    <legend>账号登录</legend>
    <p id="radio">
