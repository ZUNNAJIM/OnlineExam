...
<form action="${pageContext.request.contextPath}/LogService/login" method="post" id="loginForm">
    <legend>账号登录</legend>
    <p id="radio">
        <input type="radio" name="identity" value="admin"  checked/><label>管理员</label>
        <input type="radio" name="identity" value="teacher"  /><label>教师</label>
        <input type="radio" name="identity" value="student" /><label>学生</label>
    </p>
    <p>
        <label>用户名：</label>
        <input type="text" id="userName" name="name" value="root" placeholder="请输入账号" />
    </p>
    <p>
        <label>密&nbsp;&nbsp;&nbsp;码：</label>
        <input type="password" id="userPwd" name="password" value="root" placeholder="请输入密码" />
    </p>
    <p>
